...
static String userInput = null;
	...
	public void ReadUtilFile() throws Exception
	{
		...
		FileInputStream fs = new FileInputStream("D:\\Quickregressiontest\\webtest\\src\\main\\resources\\Config\\config.properties");
		CONFIG.load(fs);
...
/*						D8 = new FirefoxDriver();
						D8.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
						D8.manage().window().maximize();*/
						System.setProperty("webdriver.firefox.marionette",ieDriverPath);
						D8 = new FirefoxDriver();
						D8.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
						D8.manage().window().maximize();
						break;						
				...
				default:
						...
						System.out.println("Error : Browser type is Inavalid");
						strcaptureerrormessage = "Invalid browser type";
						Func_ExcutionLogs("error"); // Log execution results in the log excel files
						chkInvalBrsr=true;
			}	
...
*/			t_testnotruncntr++;
		...
		for (j = 0; j < TScrowcount; j++) 
		{
...

			{
				...
				catch (Exception e)
				{
					...
					strcaptureerrormessage = "File not found:"+e.getMessage();
					Func_ExcutionLogs("error");			
				}
...

				{
					...
					System.out.print(e);
					strcaptureerrormessage = "Excel file of Open2Test is not correct."+e.getMessage();
					Func_ExcutionLogs("error");	
				}
		...
		try 
		{
			...
			if ((ActionVal).equalsIgnoreCase("check"))
			{
				...
				if (expval.equalsIgnoreCase(actval)) 
				{
					...
					System.out.println(j + 1 +" | "+ Action +" | "+ cCellData +" | "+ dCellData +"->"+ "executed");
				...
				else 
				{
					...
					if (ORvalname == "exit") 
					{
						...
						System.out.println(j + 1 +" | "+ Action +" | "+ cCellData +" | "+ dCellData +"->"+ "missing");
					} 
					else 
					{
						Update_Report("failed", ObjectSetCh, ObjectSetValCh);
						System.out.println(j + 1 +" | "+ Action +" | "+ cCellData +" | "+ dCellData);
					}
					if (capturecheckvalue == true)
					{
						screenshot(loopnum, TScrowcount, TScname);
...

	{
		...
		catch (Exception e)
		{
			...
			System.out.println(j + 1 +" | "+ Action +" | "+ cCellData +" | "+ dCellData +"->"+ "failed");
			elem = null;
		}
	}
		...
		try
		{
			...
			case "callfunction":
				...
				try {
					...
					System.out.println(j + 1 +" | "+ Action +" | "+ cCellData +" | "+ dCellData +"->"+ "userdefined");
				}
				break;
			...
			if (cCellData.contains("xls")) {
				...
				try {
					...
					System.out.println(j + 1 +" | "+ Action +" | "+ cCellData +" | "+ dCellData +"->"+ "callactionstart");
					introwcnt = 0;
					int jloop;
					...
					System.out.println(j + 1 +" | "+ Action +" | "+ cCellData +" | "+ dCellData +"->"+ "callaction");
					j = introwcntStore;	
					}	
					 catch (FileNotFoundException FNF1)
					{
						 Update_Report("callactionfnf");
						 System.out.println(j + 1 +" | "+ Action +" | "+ cCellData +" | "+ dCellData +"->"+ "callactionfnf");
					}					
				}
					else
				{	
					Update_Report("callactionff");
					System.out.println(j + 1 +" | "+ Action +" | "+ cCellData +" | "+ dCellData +"->"+ "callactionff");
				}
				break;					
								...
								if(!((ObjectSetVal.equalsIgnoreCase("page")||(ObjectSetVal.equalsIgnoreCase("page;")))||(ObjectSetVal.toString()=="")))
								{
									...
									if(D8.getTitle().toString().equalsIgnoreCase(ObjectSetVal)== false)
									{
										...
										if(windowFound!=1)
										{
											...
											System.out.println(j + 1 +" | "+ Action +" | "+ cCellData +" | "+ dCellData +"->"+ "NoWndowFound");
										}
									}
								}				
								else
								{
									...
									else
									{
										...
										if(windowFound!=1)
										{
											...
											System.out.println(j + 1 +" | "+ Action +" | "+ cCellData +" | "+ dCellData +"->"+ "NoWindowFound");
										}
				...
				try {
					...
					if (elem == null) {
						...
						if (ObjectSet == "") {
							...
							System.out.println(j + 1 +" | "+ Action +" | "+ cCellData +" | "+ dCellData +"->"+ "filePathNotFound");
						} else {
							try {
						...
						if(dCellDataVal.length>2) ////Updated on 16.12.2013 for TextElement support -Text Element Might have contained more than two:
						{
							for(int dCellvalcount=2;dCellvalcount<dCellDataVal.length;dCellvalcount++)
							{
									...
									
								{
									...
									System.out.println(j + 1 +" | "+ Action +" | "+ cCellData +" | "+ dCellData +"->"+ "toManyArgument");
									break;
								}
								else
								{
		...
		try {
			...
			////Function was updated on 16.12.2013 for supporting page, dialog and textelement
				...
				else if (ObjectSetVal.contains("dt_"))
				{
					...
					{
						Update_Report("toomanyarguments");
						//System.out.println(j + 1 +" | "+ Action +" | "+ cCellData +" | "+ dCellData +"->"+ "toManyArguments");
					}
				}
	...
	public static void Sent_Mail() throws MessagingException{	
	    ...
	    String CC=CONFIG.getProperty("mail_CC");
	      ...
	      //  message1.append( "Note: The file of plans along with supporting documents will be accepted only after the payment of necessary fees" +"\r\n");
	        ...
	        message1.append( "AB Rahim"   +"\r\n");
	        message1.append( "Automation Test"   +"\r\n");
	        message1.append( "Surat"   +"\r\n");
		    
	        
	        String bodymessage = "<i>Automated test execution summary report!</i><br>";
	        bodymessage += "<b>Here attaching test execution summary report!</b><br>";
	        bodymessage += "<b>Test summary report containing test case results & test scripts status.</b><br>";
	        bodymessage += "<font color=Blue>Please find test summary report.</font><br>";
	        bodymessage += "<br>";
	        bodymessage += "<br>";
	        bodymessage += "<font color=Blue>Thanks & regards,</font><br>";
	        bodymessage += "<font color=Blue>Automate Testing Team</font><br>";
	        ...
	        messageBodyPart.setFileName("Test Summary"+reporttime+".html");
	        
	        
	        //------Html test message sent-----------------
	        ...
	        //multipart.setContent(messageBodyPart);
	        //message.setContent(multipart);
	        try {
...
/*						String[] File = cCellData.split(";");
					...
					case "listselect":
							...
							
							{
								...
								System.out.println(j + 1 +" | "+ Action +" | "+ cCellData +" | "+ dCellData +"->"+ "NoBlankAvailable");
							}
							else
							{
								Update_Report("executed",ObjectSet,ObjectSetVal);
					...
					case "select":
						...
						else
						{
							if (new Select(elem).getOptions().toString().contains("")==true)
							{
								...
								{
									Update_Report("NoBlankAvailable");
									System.out.println(j + 1 +" | "+ Action +" | "+ cCellData +" | "+ dCellData +"->"+ "NoBlankFound");
								}
							}
							else
							{
						...
						if (cCellObjType.equalsIgnoreCase("calendar")
							...
							try {
								...
								if (Integer.parseInt(mm) > 12
									...
									System.out.println(j + 1 +" | "+ Action +" | "+ cCellData +" | "+ dCellData +"->"+ "InvalidDate");
								} else {
							...
							System.out.println(j + 1 +" | "+ Action +" | "+ cCellData +" | "+ dCellData +"->"+ "calenderaction");
						}
						break;	
...
/*        DateFormat dateFormat2 = new SimpleDateFormat("dd"); 
	...
	public void selectDate(String mm2, String dd2, String yyyy2)
		...
		default:
			...
			System.out.println(j + 1 +" | "+ Action +" | "+ cCellData +" | "+ dCellData +"->"+ "invalidMonth");
			break;
		}
		int titleLength;
		...
		case "jquery":
			if (!(lastSelecteddateJQ == setdd && lastSelectedmonthJQ == setmm && lastSelectedyearJQ == setyyyy)) {
				...
				if (objectfound == 0) {
					...
					System.out.println(j + 1 +" | "+ Action +" | "+ cCellData +" | "+ dCellData +"->"+ "prevmonth");
					break;
				} else {
					objectfound = 0;
				}
				...
				if (objectfound == 0) {
					...
					System.out.println(j + 1 +" | "+ Action +" | "+ cCellData +" | "+ dCellData +"->"+ "nextmonth");
					break;
				} else {
					objectfound = 0;
				}
				...
				if (objectfound == 0) {
					...
					System.out.println(j + 1 +" | "+ Action +" | "+ cCellData +" | "+ dCellData +"->"+ "titlemonth");
					break;
				} else {
					objectfound = 0;
				}
				...
				if (objectfound == 0) {
					...
					System.out.println(j + 1 +" | "+ Action +" | "+ cCellData +" | "+ dCellData +"->"+ "titleyear");
					break;
				} else {
					objectfound = 0;
				}
				...
				default:
					...
					System.out.println(j + 1 +" | "+ Action +" | "+ cCellData +" | "+ dCellData +"->"+ "monthnotified");
					break;
				}
	...
	public static void func_InvokeFunction(String functionName,
		...
		try {
			Seleniumwd3 s1 = new Seleniumwd3();
			Method[] declaredMethods = Seleniumwd3.class.getDeclaredMethods();
